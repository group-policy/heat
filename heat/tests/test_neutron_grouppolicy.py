...
from heat.engine.resources.neutron import grouppolicy
...
class EndpointTest(HeatTestCase):
    ...
    def setUp(self):
        ...
        self.m.StubOutWithMock(neutronclient.Client, 'create_endpoint')
        self.m.StubOutWithMock(neutronclient.Client, 'delete_endpoint')
        self.m.StubOutWithMock(neutronclient.Client, 'show_endpoint')
        self.m.StubOutWithMock(neutronclient.Client, 'update_endpoint')
        self.stub_keystoneclient()

    def create_endpoint(self):
        neutronclient.Client.create_endpoint({
            'endpoint': {
                'name': 'test-endpoint',
                'endpoint_group_id': 'epg-id',
                "description": "test endpoint resource"
    ...
    def test_delete(self):
        neutronclient.Client.delete_endpoint('5678')
        neutronclient.Client.show_endpoint('5678').AndRaise(
    ...
    def test_delete_already_gone(self):
        neutronclient.Client.delete_endpoint('5678').AndRaise(
            grouppolicy.NeutronClientException(status_code=404))
    ...
    def test_update(self):
        rsrc = self.create_endpoint()
        neutronclient.Client.update_endpoint(
...
class EndpointGroupTest(HeatTestCase):
    ...
    def setUp(self):
        ...
        self.m.StubOutWithMock(neutronclient.Client, 'create_endpoint_group')
        self.m.StubOutWithMock(neutronclient.Client, 'delete_endpoint_group')
        self.m.StubOutWithMock(neutronclient.Client, 'show_endpoint_group')
        self.m.StubOutWithMock(neutronclient.Client, 'update_endpoint_group')
        self.stub_keystoneclient()

    def create_endpoint_group(self):
        neutronclient.Client.create_endpoint_group({
            "endpoint_group": {
                "name": "test-endpoint-group",
                "description": "test endpoint group resource",
                "l2_policy_id": "l2-policy-id",
    ...
    def test_delete(self):
        neutronclient.Client.delete_endpoint_group('5678')
        neutronclient.Client.show_endpoint_group('5678').AndRaise(
            grouppolicy.NeutronClientException(status_code=404))
    ...
    def test_delete_already_gone(self):
        neutronclient.Client.delete_endpoint_group('5678').AndRaise(
            grouppolicy.NeutronClientException(status_code=404))
    ...
    def test_update(self):
        rsrc = self.create_endpoint_group()
        neutronclient.Client.update_endpoint_group(
...
class L2PolicyTest(HeatTestCase):
    ...
    def setUp(self):
        ...
        self.m.StubOutWithMock(neutronclient.Client, 'create_l2_policy')
        self.m.StubOutWithMock(neutronclient.Client, 'delete_l2_policy')
        self.m.StubOutWithMock(neutronclient.Client, 'show_l2_policy')
        self.m.StubOutWithMock(neutronclient.Client, 'update_l2_policy')
        self.stub_keystoneclient()

    def create_l2_policy(self):
        neutronclient.Client.create_l2_policy({
            'l2_policy': {
                "name": "test-l2-policy",
                "description": "test L2 policy resource",
                "l3_policy_id": "l3-policy-id"
    ...
    def test_delete(self):
        neutronclient.Client.delete_l2_policy('5678')
        neutronclient.Client.show_l2_policy('5678').AndRaise(
            grouppolicy.NeutronClientException(status_code=404))
    ...
    def test_delete_already_gone(self):
        neutronclient.Client.delete_l2_policy('5678').AndRaise(
            grouppolicy.NeutronClientException(status_code=404))
    ...
    def test_update(self):
        rsrc = self.create_l2_policy()
        neutronclient.Client.update_l2_policy(
...
class L3PolicyTest(HeatTestCase):
    ...
    def setUp(self):
        ...
        self.m.StubOutWithMock(neutronclient.Client, 'create_l3_policy')
        self.m.StubOutWithMock(neutronclient.Client, 'delete_l3_policy')
        self.m.StubOutWithMock(neutronclient.Client, 'show_l3_policy')
        self.m.StubOutWithMock(neutronclient.Client, 'update_l3_policy')
        self.stub_keystoneclient()

    def create_l3_policy(self):
        neutronclient.Client.create_l3_policy({
            'l3_policy': {
                "name": "test-l3-policy",
                "description": "test L3 policy resource",
                "ip_version": "4",
    ...
    def test_delete(self):
        neutronclient.Client.delete_l3_policy('5678')
        neutronclient.Client.show_l3_policy('5678').AndRaise(
            grouppolicy.NeutronClientException(status_code=404))
    ...
    def test_delete_already_gone(self):
        neutronclient.Client.delete_l3_policy('5678').AndRaise(
            grouppolicy.NeutronClientException(status_code=404))
    ...
    def test_update(self):
        rsrc = self.create_l3_policy()
        neutronclient.Client.update_l3_policy(
...
class PolicyClassifierTest(HeatTestCase):
    ...
    def create_policy_classifier(self):
        neutronclient.Client.create_policy_classifier({
            'policy_classifier': {
                "name": "test-policy-classifier",
                "description": "test policy classifier resource",
                "protocol": "tcp",
    ...
    def test_delete(self):
        neutronclient.Client.delete_policy_classifier('5678')
        neutronclient.Client.show_policy_classifier('5678').AndRaise(
            grouppolicy.NeutronClientException(status_code=404))
    ...
    def test_delete_already_gone(self):
        neutronclient.Client.delete_policy_classifier('5678').AndRaise(
            grouppolicy.NeutronClientException(status_code=404))
    ...
    def test_update(self):
        rsrc = self.create_policy_classifier()
        neutronclient.Client.update_policy_classifier(
...
class PolicyActionTest(HeatTestCase):
    ...
    def setUp(self):
        ...
        self.m.StubOutWithMock(neutronclient.Client, 'create_policy_action')
        self.m.StubOutWithMock(neutronclient.Client, 'delete_policy_action')
        self.m.StubOutWithMock(neutronclient.Client, 'show_policy_action')
        self.m.StubOutWithMock(neutronclient.Client, 'update_policy_action')
        self.stub_keystoneclient()

    def create_policy_action(self):
        neutronclient.Client.create_policy_action({
            'policy_action': {
                "name": "test-policy-action",
                "description": "test policy action resource",
                "action_type": "redirect",
    ...
    def test_delete(self):
        neutronclient.Client.delete_policy_action('5678')
        neutronclient.Client.show_policy_action('5678').AndRaise(
            grouppolicy.NeutronClientException(status_code=404))
    ...
    def test_delete_already_gone(self):
        neutronclient.Client.delete_policy_action('5678').AndRaise(
            grouppolicy.NeutronClientException(status_code=404))
    ...
    def test_update(self):
        rsrc = self.create_policy_action()
        neutronclient.Client.update_policy_action(
...
class PolicyRuleTest(HeatTestCase):
    ...
    def setUp(self):
        ...
        self.m.StubOutWithMock(neutronclient.Client, 'create_policy_rule')
        self.m.StubOutWithMock(neutronclient.Client, 'delete_policy_rule')
        self.m.StubOutWithMock(neutronclient.Client, 'show_policy_rule')
        self.m.StubOutWithMock(neutronclient.Client, 'update_policy_rule')
        self.stub_keystoneclient()

    def create_policy_rule(self):
        neutronclient.Client.create_policy_rule({
            'policy_rule': {
                "name": "test-policy-rule",
                "description": "test policy rule resource",
                "enabled": True,
    ...
    def test_delete(self):
        neutronclient.Client.delete_policy_rule('5678')
        neutronclient.Client.show_policy_rule('5678').AndRaise(
            grouppolicy.NeutronClientException(status_code=404))
    ...
    def test_delete_already_gone(self):
        neutronclient.Client.delete_policy_rule('5678').AndRaise(
            grouppolicy.NeutronClientException(status_code=404))
    ...
    def test_update(self):
        rsrc = self.create_policy_rule()
        neutronclient.Client.update_policy_rule(
...
class ContractTest(HeatTestCase):
    ...
    def setUp(self):
        ...
        self.m.StubOutWithMock(neutronclient.Client, 'create_contract')
        self.m.StubOutWithMock(neutronclient.Client, 'delete_contract')
        self.m.StubOutWithMock(neutronclient.Client, 'show_contract')
        self.m.StubOutWithMock(neutronclient.Client, 'update_contract')
        self.stub_keystoneclient()

    def create_contract(self):
        neutronclient.Client.create_contract({
            'contract': {
                "name": "test-contract",
                "description": "test contract resource",
                "parent_id": "3456",
    ...
    def test_delete(self):
        neutronclient.Client.delete_contract('5678')
        neutronclient.Client.show_contract('5678').AndRaise(
            grouppolicy.NeutronClientException(status_code=404))
    ...
    def test_delete_already_gone(self):
        neutronclient.Client.delete_contract('5678').AndRaise(
            grouppolicy.NeutronClientException(status_code=404))
    ...
    def test_update(self):
        rsrc = self.create_contract()
        neutronclient.Client.update_contract(

...
class Endpoint(neutron.NeutronResource):
    ...
    def handle_update(self, json_snippet, tmpl_diff, prop_diff):
        if prop_diff:
            self.neutron().update_endpoint(
                self.resource_id, {'endpoint': prop_diff})


class EndpointGroup(neutron.NeutronResource):
    ...
    def handle_update(self, json_snippet, tmpl_diff, prop_diff):
        if prop_diff:
            self.neutron().update_endpoint_group(
                self.resource_id, {'endpoint_group': prop_diff})


class L2Policy(neutron.NeutronResource):
    ...
    def handle_update(self, json_snippet, tmpl_diff, prop_diff):
        if prop_diff:
            self.neutron().update_l2_policy(
                self.resource_id, {'l2_policy': prop_diff})


class L3Policy(neutron.NeutronResource):
    ...
    def handle_update(self, json_snippet, tmpl_diff, prop_diff):
        if prop_diff:
            self.neutron().update_l3_policy(
                self.resource_id, {'l3_policy': prop_diff})


class PolicyClassifier(neutron.NeutronResource):
    ...
    def handle_update(self, json_snippet, tmpl_diff, prop_diff):
        if prop_diff:
            self.neutron().update_policy_classifier(
                self.resource_id, {'policy_classifier': prop_diff})


class PolicyAction(neutron.NeutronResource):
    ...
    def handle_update(self, json_snippet, tmpl_diff, prop_diff):
        if prop_diff:
            self.neutron().update_policy_action(
                self.resource_id, {'policy_action': prop_diff})


class PolicyRule(neutron.NeutronResource):
    ...
    def handle_update(self, json_snippet, tmpl_diff, prop_diff):
        if prop_diff:
            self.neutron().update_policy_rule(
                self.resource_id, {'policy_rule': prop_diff})


class Contract(neutron.NeutronResource):
